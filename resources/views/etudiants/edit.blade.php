                    ...
                    @method('PUT')
                        <div class="row">
                            <div class="control-group">
                                ...
                                <input value="{{ $etudiant->nom }}" type="text" name="nom" id="nom" class="form-control mt-2">
                            </div>
                            ...
                            <div class="control-group mt-2">
                                ...
                                <input value="{{ $etudiant->email }}" type="email" name="email" id="email" class="form-control mt-2">
                            </div>
                            <div class="control-group mt-2">
